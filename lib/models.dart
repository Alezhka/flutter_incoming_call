...
class CallEvent extends BaseCallEvent {
  ...
  CallEvent(
      {required this.action, required this.uuid, required this.name, required this.handleType, required this.avatar});
  ...
  @override
  String toString() => 'CallEvent { uuid: $uuid, name: $name, handleType: $handleType, avatar: $avatar }';
}
...
class HoldEvent extends BaseCallEvent {
  ...
  HoldEvent({required this.uuid, required this.hold});
  ...
  @override
  String toString() => 'HoldEvent { uuid: $uuid, hold: $hold }';
}
...
class MuteEvent extends BaseCallEvent {
  ...
  MuteEvent({required this.uuid, required this.mute});
  ...
  @override
  String toString() => 'MuteEvent { uuid: $uuid, mute: $mute }';
}
...
class DmtfEvent extends BaseCallEvent {
  ...
  DmtfEvent({required this.uuid, required this.digits});
  ...
  @override
  String toString() => 'DmtfEvent { uuid: $uuid, digits: $digits }';
}

class AudioSessionEvent extends BaseCallEvent {
  final bool activate;

  AudioSessionEvent({required this.activate});
  ...
  @override
  String toString() => 'AudioSessionEvent { activate: $activate }';
}
